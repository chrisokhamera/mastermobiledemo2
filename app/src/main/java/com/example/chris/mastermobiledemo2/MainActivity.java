      ...
      */
        myMovieListing.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                movieDetailsIntent.putExtra("MovieYear", chosenMovie.Year);
                movieDetailsIntent.putExtra("MovieDirector", chosenMovie.Director);
                movieDetailsIntent.putExtra("MovieCast", chosenMovie.Cast);
                movieDetailsIntent.putExtra("MovieNotes", chosenMovie.Notes);
                //movieDetailsIntent.putExtra("MovieRuntime", chosenMovie.RunningTimes);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < listOfMoviesFromJSON.length(); i++) {
                    ...
                    Log.i("Movie Year", jsonPart.getString("year"));
                    Log.i("Movie Director", jsonPart.getString("director"));
                    Log.i("Movie Cast", jsonPart.getString("cast"));
                    Log.i("Movie Notes", jsonPart.getString("notes"));
                   // Log.i("Movie RunningTimes", jsonPart.getString("runningTimes"));
                    ...
                    String director = jsonPart.getString("director");
                    String cast = jsonPart.getString("cast");
                    String notes = jsonPart.getString("notes");
                    //String runningTimes = jsonPart.getString("runningTimes");

                    MovieObject m = new MovieObject(title, genre, year, director, cast, notes);
